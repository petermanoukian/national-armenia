                ...
                <div class="carousel slide banner_slider col-12 " data-ride="carousel">
                    <div class="carousel-inner ">
						...
						class="carousel-item" v-bind:class="{ 'active' : index == 1}">
                            <img 
							v-bind:src="'https://www.socialist-armenia.org/images/news/' + prod.img" v-bind:alt = prod.name 
							/>
...
{{ prod.name }} &raquo;  Read More</router-link> <br><br>
                ...
                <div class="col-md-6">
                    <div class="belarus_items"> 
                       <img 
							v-bind:src=
							"'https://www.socialist-armenia.org/images/news/' + homecatdetail1.img" 
							v-bind:alt = homecatdetail1.name class='maximg'
						/>
						
                        <div class="belarus_content">
						
						   <router-link  class="heding wow fadeInUp marginbottom10" 
								data-wow-delay="0.2s" 
								:to="{ name: 'political', params: { catid: homecatdetail1.id , cat:homecatdetail1.name  } }">     
							{{ homecatdetail1.name }}
							</router-link>
							
							 <router-link  class="wow fadeInUp tag_btn" data-wow-delay="0.4s"
						:to="{ name: 'political', params: { catid: homecatdetail1.id , cat:homecatdetail1.name  } }">	
										View Articles 			
							</router-link>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="belarus_items"> 
                       <img 
						v-bind:src="'https://www.socialist-armenia.org/images/news/' + homecatdetail2.img" 
						v-bind:alt = homecatdetail2.name 
						class='maximg'/>
                        ...
                        <div class="belarus_content">
						   ...
						   <router-link  class="heding wow fadeInUp marginbottom10" 
								data-wow-delay="0.2s" 
								:to="{ name: 'political', params: { catid: homecatdetail2.id , cat:homecatdetail2.name  } }">     
							{{ homecatdetail2.name }}
							</router-link>
