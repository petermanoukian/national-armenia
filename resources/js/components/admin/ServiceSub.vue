				...
				<div class="card-header">
					...
					<div>
						...
						<div class = 'marginleft5 margintop8-4-5'>
							...
							<span class = 'marginleft' v-if="typeof this.ViewServimg.serv_id !== 'undefined' 
								&& this.ViewServimg.serv_id !== null && this.ViewServimg.serv_id !== '' ">
									<router-link :to="{ name: 'addservicesub', params: { servid: this.ViewServimg.serv_id } }"
					...
					<div class="card-body">
						...
						<pagination :data="servsubs" @pagination-change-page="fetchServimgs"></pagination>
  ...
  export default 
  {
		 ...
		 mounted: function()
        {
			...
			if(app.$route.params.servid)
			{
				...
				this.ViewServimg.serv_id = idserv;
				console.log(' idserv ' + idserv);
				this.fetchPortDetails(idserv);
			}
			this.fetchServimgs();
        ...
        methods: 
		{
            fetchServimgs(page) {
				...
				if(apper.ViewServimg.serv_id != null)
				{
					let serverid = apper.ViewServimg.serv_id;
					url = '/admin/servicesub/json/'+serverid+'?page=' + page;
					console.log('line 117 ' + url + ' theservid ' + serverid);
				}
				else
				{

					
					url = '/admin/servicesuber/json/?page=' + page;
