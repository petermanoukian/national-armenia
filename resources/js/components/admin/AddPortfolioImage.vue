		...
		<div class="col-md-6">
			<div class="card">
				<div class="card-header">
					<h3>Add More Images to Gallery </h3>
					</div>
					<div class="card-body">
						<form @submit.prevent="addportfolioimg">		
							...
							<div class="form-group row">
								...
								placeholder= 'Select One' >
									<option v-if ="portId === ''" value = '' disabled> Choose Gallery </option>
			...
			// console.log('logo ' +  this.formAddPortimg.logo);
             ...
             axios.post('/admin/portimg/post',  this.formAddPortimg).then(function (resp) {
				// this.$router.push({path: '/admin/login'});
				 ...
				 fm.loader = false;
				 let portid = fm.formAddPortimg.portid; 
				 let returnurl = `/admin/portfolioimg/${fm.formAddPortimg.portid}`;
